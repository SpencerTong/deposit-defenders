...
export const guideArticles: GuideArticle[] = [
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Under §15B(4), your landlord must return your security deposit, minus any lawful deductions, within 30 days after the end of your tenancy. Lawful deductions are limited: unpaid rent, unpaid real estate tax increases you agreed to in the lease, and the cost to repair damage beyond reasonable wear and tear — and damage deductions only count if you received an itemized list, sworn under pains and penalties of perjury, within that same 30-day window.",
      ...
      },
      {
        ...
        paragraphs: [
          "Start with a written demand letter: state the facts, cite §15B(4), §15B(6)(e), and §15B(7), name the amount, and give a 10-business-day deadline. Send it certified mail with return receipt. If the deadline passes, Massachusetts small claims court handles exactly this kind of case — no lawyer required.",
        ],
      },
    ],
    faq: [
      {
        ...
        answer:
          "The statute counts 30 days from the end of the tenancy without carving out weekends or holidays — treat it as calendar days.",
      },
      {
  ...
  },
  {
    ...
    ctaBody:
      "Enter your deductions and we'll flag which ones are commonly contestable as wear and tear — and generate a free demand letter.",
    ctaHref: "/",
    ctaLabel: "Check my deductions — it's free",
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Under §15B(2)(c), a landlord taking a security deposit must give you a signed, separate written statement of the present condition of the premises — upon receiving the deposit or within 10 days after the tenancy begins, whichever is later. You then have 15 days to note any damage you disagree with and return it.",
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "A judgment isn't self-enforcing, but the courts have collection procedures — payment hearings and orders the court can enforce. The clerk's office can explain the options for your court.",
      },
    ],
    related: [
      "landlord-didnt-return-security-deposit-30-days-massachusetts",
